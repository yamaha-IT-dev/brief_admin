...
set rs=server.createobject("ADODB.recordset")
	...
	strSQL = strSQL & "				AND B9URKC LIKE '%" & UCASE(strUser) & "%' "
...
Response.AddHeader "Content-Disposition", "attachment; filename=loanstock_" & strUser & ".xls"

if rs.eof <> true then
	response.write "<table border=1>"
	response.write "<tr>"
	response.write "<td align=""left""><strong>Owner</strong></td>"
	...
	wend
	response.write "<tr>"
	response.write "<td colspan=""7"" align=""center"">Total LIC: $" & FormatNumber(intTotalLIC) & "</td>"
	response.write "</tr>"
	response.write "<tr>"
	response.write "<td colspan=""7"" align=""center"">Total: " & intTotalQty & " stocks</td>"
	response.write "</tr>"
