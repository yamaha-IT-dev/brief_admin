...
<title>#View Firesale Winner</title>
...
Function getUser(intID)
    ...
    if not DB_RecSetIsEmpty(rs) Then
		...
		session("winner_sales_order_no") 	= rs("regSalesOrderNo2")
		session("winner_invoice_no") 		= rs("regInvoiceNo2")
...
sub updateWinner
	...
	strSQL = strSQL & "regSalesOrderNo2 = '" & strSalesOrderNo & "',"
	strSQL = strSQL & "regInvoiceNo2 = '" & strInvoiceNo & "',"
...
sub listWinningItems
	...
	'strSQL = strSQL & " 		AND aucEnded = 'Y' "
	strSQL = strSQL & " 		AND aucFiresale = '1' "
...
<table border="0" cellpadding="0" cellspacing="0" width="800">
  <tr>
    <td class="first_content"><h2>Update Firesale Winner</h2>
      <p><img src="images/backward_arrow.gif" /> <a href="list_winners2.asp">Back to Winner List</a></p>
