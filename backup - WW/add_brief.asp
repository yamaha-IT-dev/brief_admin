                ...
                <table cellpadding="5" cellspacing="0" class="item_maintenance_box">
                    ...
                    <tr>
                        <td colspan="3">
                            ...
                            <br />
                            <textarea name="txtDescription" id="txtDescription" cols="60" rows="6" onKeyDown="limitText(this.form.txtDescription,this.form.countdown,500);" onKeyUp="limitText(this.form.txtDescription,this.form.countdown,500);"><%= Session("new_project_description") %></textarea>
                            <br />
