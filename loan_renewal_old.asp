        ...
        For intRecord = 1 To rs.PageSize
            ...
            Select Case	rs("renStatus")
                ...
                case 1
                    ...
                    strDisplayList = strDisplayList & "         <input type=""submit"" value=""Approve"" class=""btn btn-success btn-sm"" />"
                    ...
                    strDisplayList = strDisplayList & "         <input type=""hidden"" name=""renItemCode"" value=""" & rs("renItemCode") & """>"
                    strDisplayList = strDisplayList & "         <input type=""hidden"" name=""renCreatedByEmail"" value=""" & rs("renCreatedByEmail") & """>"
                    strDisplayList = strDisplayList & "         <input type=""submit"" value=""Reject"" class=""btn btn-danger btn-sm"" />"
                    strDisplayList = strDisplayList & "	    </form>"
...
sub main
    ...
    if Request.ServerVariables("REQUEST_METHOD") = "POST" then
        ...
        select case Trim(Request("Action"))
            case "Approve"
                call approveLoanRenewal(intRenewalID, strItemCode, strCreatedByEmail, session("logged_username"))
                call incrementRenewalCounter(strOrderNo, strOrderLine)
            case "Reject"
                call rejectLoanRenewal(intRenewalID, strItemCode, strCreatedByEmail, session("logged_username"))
        end select
    end if
