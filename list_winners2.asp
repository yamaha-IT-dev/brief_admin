...
<title>#FiresaleWinnersOnly</title>
<link REL="stylesheet" HREF="include/stylesheet.css" TYPE="text/css">
<script language="JavaScript" type="text/javascript">
function searchWinner(){    
    var strSearch 		= document.forms[0].txtSearch.value;
	var strStatus 		= document.forms[0].cboStatus.value;
    document.location.href = 'list_winners2.asp?type=search&txtSearch=' + strSearch + '&cboStatus=' + strStatus;	
}
    
function resetSearch(){
	document.location.href = 'list_winners2.asp?type=reset';    
}  
</script>
</head>
<body>
...
sub listWinner	
	...
	strSQL = strSQL & "		AND regID IN (SELECT aucCurrentBidder FROM tblQAAuctions WHERE aucEnded = 'Y' AND aucFiresale = '1')"
	...
	if not DB_RecSetIsEmpty(rs) Then
		...
		For intRecord = 1 To rs.PageSize 			
			...
			strDisplayList = strDisplayList & "<td align=""center"" nowrap><a href=""update_winner2.asp?id=" & rs("regID") & """>Edit</a></td>"
			...
			strDisplayList = strDisplayList & "<td align=""center"">" & rs("regSalesOrderNo2") & "</td>"
			strDisplayList = strDisplayList & "<td align=""center"">" & rs("regInvoiceNo2") & "</td>"
...
<table border="0" cellpadding="0" cellspacing="0" width="600">
  <tr>
    <td valign="top" class="maincontent"><h2><a href="list_winners.asp">yBay Winners</a> | Firesale Winners</h2>
      <div class="alert alert-search">
        <form name="frmSearch" id="frmSearch" action="list_winners2.asp?type=search" method="post" onsubmit="searchWinner()">
