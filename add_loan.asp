...
sub main				
	...
	loanLocation		= Trim(Request.Form("txtLocation"))	
	loanComments		= Trim(Request.Form("txtComments"))

	if Request.ServerVariables("REQUEST_METHOD") = "POST" then
		select case Trim(Request("Action"))
			case "Add"
				call addLoan(loanAccount, loanProduct, loanSerialNo, loanQty, loanLIC, loanDate, loanFirstExpiryDate, loanFinalExpiryDate, loanOrderNo, loanShipmentNo, loanLocation, loanComments, session("logged_username"))
		end select
	end if
end sub
        ...
        <table cellpadding="5" cellspacing="0" class="item_maintenance_box">
          ...
          <tr>
            ...
            <td><input type="hidden" name="Action" />
              <input type="submit" value="Add Location" /></td>
          </tr>
        </table>
      </form></td>
  </tr>
