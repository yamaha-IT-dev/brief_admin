...
sub displayLoanStock
	...
	strSQL = strSQL & ", product_code, traModelNo "
	...
	if not DB_RecSetIsEmpty(rs) Then	
		...
		For intRecord = 1 To rs.PageSize
			...
			if IsNull(rs("product_code")) then
				...
				strDisplayList = strDisplayList & "		<input type=""submit"" value=""Add to workflow"" class=""btn btn-info"" />"
			...
			'if IsNull(rs("product_code")) then
				...
				strDisplayList = strDisplayList & "		<input type=""hidden"" name=""order_no"" value=""" & Trim(rs("order_no")) & """>"
				strDisplayList = strDisplayList & "		<input type=""hidden"" name=""order_line"" value=""" & Trim(rs("order_line")) & """>"	
				strDisplayList = strDisplayList & "		<input type=""submit"" value=""Transfer"" class=""btn btn-success"" />"
				strDisplayList = strDisplayList & "	</form>"
			else
				strDisplayList = strDisplayList & "<img src=""images/tick.gif"">"					
			end if
			strDisplayList = strDisplayList & "</td>"
			strDisplayList = strDisplayList & "<td align=""left""><a name=""" & Trim(rs("order_no")) & "" & Trim(rs("order_line")) & """></a><strong>" & rs("item_code") & "</strong></td>"
			...
			if IsNull(rs("stockLocation")) then
				...
				strDisplayList = strDisplayList & "				<input type=""hidden"" name=""order_no"" value=""" & Trim(rs("order_no")) & """>"
				strDisplayList = strDisplayList & "				<input type=""hidden"" name=""order_line"" value=""" & Trim(rs("order_line")) & """>"
				strDisplayList = strDisplayList & "				<input type=""text"" id=""txtLocation"" name=""txtLocation"" class=""form-control"" maxlength=""100"" size=""18"" required>"
				strDisplayList = strDisplayList & "			</td>"
				...
				strDisplayList = strDisplayList & "				<input type=""text"" id=""txtLocation"" name=""txtLocation"" class=""form-control"" maxlength=""100"" size=""18"" value=""" & rs("stockLocation") & """ required>"
				strDisplayList = strDisplayList & "			</td>"
				strDisplayList = strDisplayList & "			<td class=""save-column""><input type=""submit"" value=""Save"" class=""btn btn-primary"" /></td>"
				strDisplayList = strDisplayList & "		</tr>"
				strDisplayList = strDisplayList & "	</table>"
	...
	strDisplayList = strDisplayList & "<tr>"
	strDisplayList = strDisplayList & "<td colspan=""14"" align=""center"">"
...
<div class="container"> <br>
  ...
  <h1><i class="fa fa-search-plus"></i> <%= session("loan_user_account") & "-" & session("account_code_ext") & " " & session("loan_user_account_name") & "" %></h1>
  ...
  <div class="row">
      ...
      <input type="button" class="btn btn-primary" name="btnSearch" value="Search" onclick="searchStock()" />
  ...
  <table class="table table-striped">
    <thead>
      <tr class="loan_header_row">
        ...
        <td align="left" width="5%" nowrap="nowrap">Transfer</td>
