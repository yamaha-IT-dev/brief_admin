...
function searchStock(){    
    ...
    document.location.href = 'loan_user0.asp?type=search&txtSearch=' + strSearch + '&sort=' + strSort;
}
    
function resetSearch(){
	document.location.href = 'loan_user0.asp?type=reset';    
}  
...
sub displayLoanStock
	...
	if not DB_RecSetIsEmpty(rs) Then	
		...
		For intRecord = 1 To rs.PageSize
			...
			strDisplayList = strDisplayList & "</td>"
			strDisplayList = strDisplayList & "<td align=""left""><a name=""" & Trim(rs("order_no")) & "" & Trim(rs("order_line")) & """></a>" & rs("item_code") & "</td>"
...
<div id="sticky_navigation_wrapper">
  <div id="sticky_navigation">
    <div class="demo_container">
      <form name="frmSearch" id="frmSearch" method="post" action="loan_user0.asp?type=search" onsubmit="searchStock()">
