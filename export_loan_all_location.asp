...
set rs=server.createobject("ADODB.recordset")
    ...
    strSQL = strSQL & "		LEFT JOIN Workflow..workflow_loan_return_item_list ON Workflow..workflow_loan_return_item_list.order_number = order_no AND Workflow..workflow_loan_return_item_list.order_lines = order_line "
    ...
    strSQL = strSQL & " ORDER BY account_name, loan_year ASC, loan_month ASC, loan_day ASC"
...
Response.AddHeader "Content-Disposition", "attachment; filename=loanstock_all.xls"
...
if rs.eof <> true then
    ...
    while not rs.eof
        ...
        response.write "<td align=""center"">" & rs.fields("lic") & "</td>"
